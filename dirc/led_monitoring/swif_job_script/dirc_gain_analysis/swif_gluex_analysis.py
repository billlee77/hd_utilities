...
DATA_OUTPUT_BASE_DIR    = "/lustre/expphy/volatile/halld/home/billlee/dirc_gain_processed_data"

# JOB EXECUTION
SCRIPTFILE        = "/home/billlee/halld_my/swif/dirc_gain_analysis/script.sh"
#ENVFILE           = "/home/billlee/setup_files/gluex_env_jlab.csh"
ENVFILE           = "/group/halld/Software/build_scripts/gluex_env_jlab.csh"
CONFIG_FILE_PATH  = "/home/billlee/halld_my/swif/dirc_gain_analysis/analysis.conf" # Be sure this path is unique for each workflow, otherwise bad juju can happen running multiple at once
TREE_NAMES        = ""

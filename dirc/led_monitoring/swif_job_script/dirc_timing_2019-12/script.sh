...
#setenv ENVIRONMENT "/home/billlee/setup_files/gluex_env_jlab.csh"
...
#source /group/halld/Software/build_scripts/gluex_env_jlab.csh /group/halld/www/halldweb/html/dist/version_jlab.xml

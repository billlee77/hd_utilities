...
#DATA_SOURCE_BASE_DIR  = "/mss/halld/RunPeriod-2019-11/calib/ver01/DIRC-LED"

#DATA_SOURCE_TYPE      = "file" #"mss" or "file"
#DATA_SOURCE_BASE_DIR  = "/cache/halld"
#DATA_SOURCE_BASE_DIR  = "/cache/halld/RunPeriod-2019-11/calib/ver01/DIRC-LED"
...
#DATA_OUTPUT_BASE_DIR    = "/lustre/expphy/volatile/halld/home/billlee/dirc_LED_Andrew_Bill_LED_2020-5"
DATA_OUTPUT_BASE_DIR    = "/lustre/expphy/volatile/halld/home/billlee/dirc_LED_skim_2020-5"
...
CONFIG_DICT["PLUGINS"]         = "DIRC_timing,DIRC_online"
...
#	print "???????????????????????????????"
	...
	for RUN in range(MINRUN, MAXRUN + 1):
		...
		DATA_SOURCE_DIR = DATA_SOURCE_BASE_DIR + "/RunPeriod-" + RUN_PERIOD + "/calib/ver01/DIRC-LED/" + FORMATTED_RUN + "/"
...
#			FILENO = FILENAME[-8:-5] #e.g. dana_rest_003185_015.hddm #Cheat!
			...
			FILENO = FILENAME[FILENAME.find('.')-3:FILENAME.find('.')] #e.g. dana_rest_003185_015.hddm #Cheat!
			print FILENAME 
			print FILENO
